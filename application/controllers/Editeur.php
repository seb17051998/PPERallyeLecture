...
class Editeur extends CI_Controller {
    ...
    function index() {
        ...
        $config['base_url']=site_url().'/Editeur/Index/page';
        $page=$this->uri->segment(4,0);
        $config['total_rows']=$this->editeurModel->get_count();
        $config['per_page']=10;
        $config['uri_segment']=4;
        $this->pagination->initialize($config);
        $data['editeur']=$this->editeurModel->get_all_editeurs($page,$config['per_page']);
